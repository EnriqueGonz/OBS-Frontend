...
const PayPal = () => {
    var { idusuario,idorder,productName,total } = useParams(); // params
    ...
    function successmethodpay(){
        ...
        axios.post('https://obsbackend.herokuapp.com/payment/api/save-payment-intent-paypal/',{
            user: idusuario,
            order: idorder,
                            ...
                            purchase_units: [
                                {
                                    ...
                                    amount: {
                                        value: 5, // Es el precio en MXN, con todo y costo de envío.
                                    },
                                },
                            ]
                        });
